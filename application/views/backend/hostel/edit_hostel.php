        ...
        <div class="col-sm-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open(base_url() . 'hostel/hostel/update/' . $hostel['hostel_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
