    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add <?php echo get_phrase('New Hostel'); ?> here<i class="btn btn-primary btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
            </div>
            <div class="panel-wrapper collapse out" aria-expanded="true">
                <div class="panel-body">

                    <?php echo form_open(base_url() . 'hostel/hostel/insert/', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <?php foreach ($select_hostel as $key => $hostel) :    ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="confirm_modal('<?php echo base_url(); ?>hostel/hostel/delete/<?php echo $hostel['hostel_id']; ?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
