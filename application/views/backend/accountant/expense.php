                ...
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            $select_expense = $this->db->get('payment')->result_array();
                            foreach ($select_expense as $key => $expense) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description; ?> <?php echo number_format($expense['amount'], 2, ".", ","); ?></td>
