        ...
        <div class="col-sm-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body table-responsive">
                    ...
                    <?php echo form_open(
                        base_url() . 'department/department/update/' . $row['department_code'],
                    ...
                    <span id="designation">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" value="<?php echo $first_designation->name; ?>" name="designation_<?php echo $first_designation->designation_id; ?>" required />
                            </div>
                        </div>
                                ...
                                if ($count > 1) { ?>
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-5">
                                            <input type="text" class="form-control" value="<?php echo $row2['name']; ?>" name="designation_<?php echo $row2['designation_id']; ?>" />
                                        </div>
