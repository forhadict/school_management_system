                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>hrm/award/delete/<?php echo $award['award_code']; ?>');" class="btn btn-danger btn-circle btn-xs" onclick="return confirm('Are you sure to delete?');" style="color:white">
