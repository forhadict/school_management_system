<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add_transport'); ?></div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_transport'); ?></div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('routes'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('vehicle'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('route_fare'); ?></div>
                                </th>
                                <th>
