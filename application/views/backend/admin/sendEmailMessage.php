                ...
                <div class="panel-body table-responsive">
                    <div class="row panel-body">
                        <div class="col-sm-9">
                            ...
                            <?php echo form_open(
                                base_url() . 'emailmessage/sendEmailMessage/create',
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea type=text name="message" id="word_count" class=" form-control" rows="11" placeholder="<?php echo get_phrase('Message Content'); ?>" required></textarea>
                                </div>
                            </div>
