    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <?php echo get_phrase(' NEW ALUMNI'); ?>


                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('ADD NEW ALUMNI HERE') ?><i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
            </div>
            <div class="panel-wrapper collapse out" aria-expanded="true">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input class="form-control m-r-10" name="graduation_year" type="date" value="<?php echo date('Y-m-d') ?>" id="example-date-input" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type='file' class="dropify" name="userfile" /required> </div> </div> <div class="form-group">
                        ...
                        <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <div><?php echo get_phrase('profession'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('graduation_year'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('school_club'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('Interest'); ?></div>
                                    </th>
                                    <th>
