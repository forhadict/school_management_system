...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_question_paper'); ?></div>
                ...
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <?php $counter = 1;
                            $exam_questions = $this->db->get('exam_question')->result_array();
                            foreach ($exam_questions as $key => $exam_question) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="label label-<?php if ($exam_question['status'] == '0') echo 'warning';
                                                                    elseif ($exam_question['status'] == '1') echo 'success';
                                                                    else echo 'danger'; ?>">
