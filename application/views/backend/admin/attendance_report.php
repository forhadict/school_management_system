        ...
        <div class="panel panel-info">
            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select id="year" class="form-control">
                                <?php $list_year = array("2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030");
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-info btn-rounded btn-block btn-sm" id="find"><i class="fa fa-search"></i>&nbsp;<?php echo get_phrase('get_attendance'); ?></button>
                    </div>
