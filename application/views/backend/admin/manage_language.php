                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div class="row panel-body">
                                            <div class="col-sm-11">
                                                <input type="text" name="phrase<?php echo $row['phrase_id']; ?>" id="phrase-<?php echo $row['phrase_id']; ?>" value="<?php echo $phrase_language; ?>" onkeyup="enableUpdateButton(<?php echo $row['phrase_id']; ?>)" class="form-control" />
                                            </div>

                                            <div class="col-sm-1">
                                                <button type="button" name="button" class="btn btn-xs btn-primary pull-right" id="button-<?php echo $row['phrase_id']; ?>" disabled onclick="updatePhrase(<?php echo $row['phrase_id']; ?>)"><i class="fa fa-check"></i>
                                                </button>
                                            </div>
                            ...
                            <table class="table" id="table_export">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div align="right"><?php echo get_phrase('actions'); ?></div>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
