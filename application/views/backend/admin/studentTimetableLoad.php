            ...
            <div class="col-sm-12">
                <div class="panel panel-info">
                    <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;
                        ...
                        <a href="<?php echo base_url(); ?>admin/class_routine_print_view/<?php echo $class_id; ?>/<?php echo $section['section_id']; ?>" class="btn btn-info btn-rounded btn-sm pull-right" target="_blank"><i class="fa fa-print"></i><?php echo get_phrase('print'); ?>
                        </a>
                    </div>
