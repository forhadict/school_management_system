                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('position_name'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('number_of_vacancies'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('last_date_of_application'); ?></div>
                                </th>
                                <th>
                            ...
                            foreach ($select_vacancy as $key => $vacancy) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_vacancy/<?php echo $vacancy['vacancy_id']; ?>');" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit" style="color:white"></i></a>
