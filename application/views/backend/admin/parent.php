    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('ADD NEW PARENT HERE'); ?><i class="btn btn-primary btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
            </div>
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            foreach ($select_parent as $key => $parent) : ?>
                                ...
                                <tr>
                                    <td><img src="<?php echo  $this->crud_model->get_image_url('parent', $parent['parent_id']); ?>" class="img-circle" width="30" height="30"></td>
