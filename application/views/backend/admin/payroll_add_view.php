                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="department_id" class="form-control select2" onchange="get_employees(this.value);" required>
                            ...
                            ?>
                                <option value="<?php echo $department['department_id'] ?>" <?php if ($department['department_id'] == $department_id) echo 'selected'; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="employee_id" class="form-control" id="employee_holder" required>
                            ...
                            <?php
                            $employee = $this->db->get_where('teacher', array('department_id' => $department_id))->result_array();
                            foreach ($employee as $key => $employee) :
                            ?>
                                <option value="<?php echo $employee['teacher_id'] ?>" <?php if ($employee['teacher_id'] == $employee_id) echo 'selected'; ?>>
    ...
    <div class="panel panel-info" data-collapsed="0">
        ...
        <div class="panel-body ">
            <span id="allowance">
                <div class="form-group">
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="allowance_type[]" placeholder="<?php echo get_phrase('type'); ?>" />
                    </div>

                    <div class="col-md-5">
                        <input type="number" class="form-control" name="allowance_amount[]" placeholder="<?php echo get_phrase('amount'); ?>" id="allowance_amount_1" />
                    </div>
                </div>
            </span>
            ...
            <span id="allowance_input">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" class="form-control" name="allowance_amount[]" placeholder="<?php echo get_phrase('amount'); ?>" id="allowance_amount" />
                    </div>
    ...
    <div class="panel panel-info" data-collapsed="0">
        ...
        <div class="panel-body ">
            <span id="deduction">
                <div class="form-group">
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="deduction_type[]" placeholder="<?php echo get_phrase('type'); ?>" />
                    </div>

                    <div class="col-md-5">
                        <input type="number" class="form-control" name="deduction_amount[]" placeholder="<?php echo get_phrase('amount'); ?>" id="deduction_amount_1" />
                    </div>
                </div>
            </span>
            ...
            <span id="deduction_input">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" class="form-control" name="deduction_amount[]" placeholder="<?php echo get_phrase('amount'); ?>" id="deduction_amount" />
                    </div>
        ...
        <div class="panel-body ">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="basic" id="basic" value="<?php echo $joining_salary; ?>" readonly />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="net_salary" id="net_salary" value="<?php echo $joining_salary; ?>" readonly />
                </div>
            </div>
...
<script type="text/javascript">
    ...
    // Creating the blank deduction input
    var blank_deduction = '';
    $(document).ready(function() {
