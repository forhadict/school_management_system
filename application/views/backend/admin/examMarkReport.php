    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        foreach ($classes as $key => $row) : ?>
                            ...
                            <select name="<?php if ($class_id == $row['class_id']) echo 'student_id';
                                            else echo 'temp'; ?>" id="student_id_<?php echo $row['class_id']; ?>" style="display:<?php if ($class_id == $row['class_id']) echo 'block';
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <select name="" id="student_id_0" style="display:<?php if (isset($student_id) && $student_id > 0) echo 'none';
