<div class="row">
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_student_house'); ?></div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                            ...
                            foreach ($houses as $key => $house) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_student_house/<?php echo $house['house_id']; ?>');"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></button>
                                        </a>
