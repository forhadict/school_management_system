    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('edit_award'); ?></div>
                <div class="panel-body table-responsive">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="name" required value="<?php echo $award['name']; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-block btn-info btn-sm btn-rounded"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('edit_award'); ?></button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
