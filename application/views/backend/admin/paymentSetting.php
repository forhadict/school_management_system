        ...
        <div class="panel panel-info">
            <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="stripe_active" class="form-control">
                            <option value="0" <?php if ($stripe[0]->stripe_active == 0) echo 'selected'; ?>>
                                <?php echo get_phrase('no'); ?></option>
                            <option value="1" <?php if ($stripe[0]->stripe_active == 1) echo 'selected'; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="testmode" class="form-control">
                            <option value="on" <?php if ($stripe[0]->testmode == 'on') echo 'selected'; ?>>
                                <?php echo get_phrase('on'); ?></option>
                            <option value="off" <?php if ($stripe[0]->testmode == 'off') echo 'selected'; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="secret_key" value="<?php echo $stripe[0]->secret_key; ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="public_key" value="<?php echo $stripe[0]->public_key; ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="secret_live_key" value="<?php echo $stripe[0]->secret_live_key; ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="public_live_key" value="<?php echo $stripe[0]->public_live_key; ?>" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="paypal_active" class="form-control">
                            <option value="0" <?php if ($paypal[0]->paypal_active == 0) echo 'selected'; ?>>
                                <?php echo get_phrase('no'); ?></option>
                            <option value="1" <?php if ($paypal[0]->paypal_active == 1) echo 'selected'; ?>>
                                <?php echo get_phrase('yes'); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="paypal_mode" class="form-control">
                            <option value="sandbox" <?php if ($paypal[0]->paypal_mode == 'sandbox') echo 'selected'; ?>>
                                <?php echo get_phrase('sandbox'); ?></option>
                            <option value="production" <?php if ($paypal[0]->paypal_mode == 'production') echo 'selected'; ?>>
