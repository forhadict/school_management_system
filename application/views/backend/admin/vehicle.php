<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add_vehicle'); ?></div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_of_vehicles'); ?></div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('vehicle_number'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('vehicle_model'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('vehicle_quantity'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('year_made'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('driver_name'); ?></div>
                                </th>
                                <th>
                        ...
                        <tbody>
                            ...
                            foreach ($vehicles as $key => $vehicle) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="label label-<?php if ($vehicle['status'] == 'available') echo 'success';
                                                                    else echo 'warning'; ?>">
