            ...
            <div class="panel-body table-responsive">
                ...
                ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type='file' class="form-control" name="userfile" onChange="readURL(this);"> <img id="blah" src="<?php echo $this->crud_model->get_image_url('admin', $row['admin_id']); ?>" alt="" height="200" width="200" />
                        </div>
                    </div>
