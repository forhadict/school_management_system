                        ...
                        <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <div><?php echo get_phrase('uploader'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('date'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('file_name'); ?></div>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                ...
                                <?php $counter = 1;
                                $syllabus =  $this->db->get_where('academic_syllabus', array('class_id' => $class_id))->result_array();
