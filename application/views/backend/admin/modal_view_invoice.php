        ...
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    ...
                    <h5><?php echo get_phrase('payment_status'); ?> : <span class="label label-<?php if ($row['status'] == '1') echo 'success';
                                                                                                elseif ($row['status'] == '2') echo 'danger';
                                                                                                else echo 'warning'; ?>">
                            <?php if ($row['status'] == 1) : ?>
                                <?php echo 'paid'; ?>
                            <?php endif; ?>
        ...
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right" valign="top">
                    <?php echo get_phrase("student's_name"); ?> : <?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->name; ?>
                    <br>
                    <?php
                    ...
                    ?>
                    <br>
                    <?php echo get_phrase("roll_number"); ?> :<?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->roll; ?>
                    <br>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" border="0">
            ...
            <tr>
                <td align="right" width="80%">
                    <h4><?php echo get_phrase('paid_amount'); ?> :</h4>
                </td>
                <td align="right">
                    <h4><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description; ?> <?php echo number_format($row['amount_paid'], 2, ".", ","); ?></h4>
                </td>
            </tr>
            <?php if ($row['due'] != 0) : ?>
                <tr>
                    <td align="right" width="80%">
                        <h4><?php echo get_phrase('due'); ?> :</h4>
                    </td>
                    <td align="right">
                        <h4><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description; ?> <?php echo number_format($row['due'], 2, ".", ","); ?></h4>
                    </td>
                </tr>
            <?php endif; ?>
        </table>
