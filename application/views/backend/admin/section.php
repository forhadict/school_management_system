                        ...
                        <ul class="nav tabs-vertical">
                            ...
                            foreach ($class as $key => $class) : ?>
                                <li class="<?php if ($class['class_id'] == $class_id) echo 'active'; ?>">
                                    <a class="btn btn-info btn-rounded btn-sm" href="<?php echo base_url(); ?>admin/sections/<?php echo $class['class_id']; ?>" style="color:white">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('section_name'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('nick_name'); ?></div>
                                </th>
                                <th>
                            ...
                            foreach ($section as $key => $section) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_section/<?php echo $section['section_id']; ?>');"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-pencil"></i></button>
                                        </a>
