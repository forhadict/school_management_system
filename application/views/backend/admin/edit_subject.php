    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-info">
                <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('update_subject'); ?></div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body table-responsive">
                            ...
                            <div class="col-sm-12">
                                <select name="class_id" class="form-control select2" required>
                                    ...
                                    foreach ($class as $key => $class) : ?>
                                        <option value="<?php echo $class['class_id']; ?>" <?php if ($subject['class_id'] == $class['class_id']) echo 'selected'; ?>>
                                            <?php echo $class['name']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-sm-12">
                                <select name="teacher_id" class="form-control select2" required>
                                    ...
                                    foreach ($teacher as $key => $teacher) : ?>
                                        ...
                                        <option value="<?php echo $teacher['teacher_id']; ?>" <?php if ($subject['teacher_id'] == $teacher['teacher_id']) echo 'selected'; ?>>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i class="fa fa-book"></i>&nbsp;<?php echo get_phrase('update_subject'); ?></button>
                        </div>
