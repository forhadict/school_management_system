    ...
    <div class="col-sm-5">
        <div class="panel panel-info">
            ...
            <div class="panel-body table-responsive">
                ...
                <?php echo form_open(
                    base_url() . 'department/department/insert',
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('department_name'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('designation'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('total_employees'); ?></div>
                                </th>
                                <th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_department/<?php echo $row['department_code']; ?>');" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit" style="color:white"></i></a>
