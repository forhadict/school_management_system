<div class="row">
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_dormitory'); ?></div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo get_phrase('room'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('category'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo get_phrase('capacity'); ?></div>
                                </th>
                                <th>
                            ...
                            foreach ($dormitories as $key => $dormitory) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_dormitory/<?php echo $dormitory['dormitory_id']; ?>');"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-pencil"></i></button>
                                        </a>
