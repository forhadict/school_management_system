 ...
 <div class="row">
     <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="white-box">
             <div class="stats-row">
                 <h3 align="center">Teacher Analysis With Joining Salary</h3>
                 ...
                 <script>
                     am4core.ready(function() {
                         ...
                         chart.data = [
                             ...
                             <?php $select_teacher = $this->db->get('teacher')->result_array(); //$this->crud_model->get_invoice_info();
                                foreach ($select_teacher as $key => $teacher_selected) : ?>

                                 {
                                     "country": "<?php echo $teacher_selected['name']; ?>",
                                     "litres": <?php echo $teacher_selected['joining_salary']; ?>
                                 },
                             <?php endforeach; ?>
