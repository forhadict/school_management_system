...
class Admin_model extends CI_Model
{
    ...
    function deleteAdministrator($param2)
    {
        ...
        $ImagePath = $this->db->get_where('admin', array('admin_id' => $param2))->row()->admin_id;
        if (file_exists('uploads/admin_image/' . $ImagePath . '.jpg')) {
            unlink('uploads/admin_image/' . $ImagePath . '.jpg');
        }
