...
class   Student_model extends CI_Model
{
    ...
    // The function below insert into student house table //
    ...
    // The function below update student house table //
    ...
    // The function below insert into student category table //
    ...
    // The function below update student category table //
    ...
    {
        $ImagePath = $this->db->get_where('student', array('student_id' => $param2))->row()->student_id;
        if (file_exists('uploads/student_image/' . $ImagePath . '.jpg')) {
            unlink('uploads/student_image/' . $ImagePath . '.jpg');
        }
        $this->db->where('student_id', $param2);
