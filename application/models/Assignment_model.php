...
class Assignment_model extends CI_Model
{
    ...
    {
        $FilePath = $this->db->get_where('assignment', array('assignment_id' => $param2))->row()->file_name;
        if (file_exists('uploads/assignment/' . $FilePath)) {
            unlink('uploads/assignment/' . $FilePath);
        }
        $this->db->where('assignment_id', $param2);
