...
class Alumni_model extends CI_Model
{
    ...
    function delete_alumni($param2)
    {
        ...
        $ImagePath = $this->db->get_where('alumni', array('alumni_id' => $param2))->row()->alumni_id;
        if (file_exists('uploads/alumni_image/' . $ImagePath . '.jpg')) {

            unlink('uploads/alumni_image/' . $ImagePath . '.jpg');
        }
        $this->db->where('alumni_id', $param2);
