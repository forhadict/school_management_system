...
class Library_model extends CI_Model
{
    ...
    {
        $ImagePath = $this->db->get_where('book', array('book_id' => $param2))->row()->book_id;
        if (file_exists('uploads/book_image/' . $ImagePath . '.jpg')) {
            unlink('uploads/book_image/' . $ImagePath . '.jpg');
        }
        $this->db->where('book_id', $param2);
        $this->db->delete('book');
    }
