...
class Admin extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('application_model');            //Load model for application
    ...
    function club($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']    = get_phrase('Manage Clubs');
    ...
    function librarian($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']    = get_phrase('Manage Librarians');
    ...
    function hrm($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']    = get_phrase('Manage Human Resources');
    ...
    /***********  The function manages Class Routine  ***********************/
    ...
    /***********  The function manages Dormitory  ***********************/
    ...
    // Student addmission get class section starts with ajax
    ...
    // Student addmission get class section ends with ajax
                ...
                if ($attendance_status == 2) {
                    if ($active_sms_gateway != '' || $active_sms_gateway != 'disabled') {
                        ...
                        if ($parent_id != null && $parent_id != 0) {
                            $parent_phone_number = $this->db->get_where('parent', array('parent_id' => $parent_id))->row()->phone;
                            if ($parent_phone_number != '' || $parent_phone_number != null) {
                                $this->sms_model->send_sms($message, $parent_phone_number);
                            } else {
    ...
    //********************* Mark attendence  Ends Here ***************//


    //********************* View attendence  Starts Here ***************//
    ...
    function marks($exam_id = null, $class_id = null, $student_id = null)
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['student_id'] > 0) {
                ...
                $this->session->set_flashdata('error_message', get_phrase('Please select all requirement'));
